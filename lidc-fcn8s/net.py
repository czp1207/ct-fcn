...
def fcn(split):
    n = caffe.NetSpec()
    pydata_params = dict(split=split, mean=(535.42605),
            seed=1795)
    if split == 'train':
        pydata_params['lidc_dir'] = '/home/zhipeng/Work/Data/LIDC-annotation'
        pylayer = 'LIDCSegDataLayer'
    else:
        pydata_params['lidc_dir'] = '/home/zhipeng/Work/Data/Val'
        pylayer = 'LIDCValDataLayer'
    n.data, n.label = L.Python(module='LIDC_layers', layer=pylayer,
